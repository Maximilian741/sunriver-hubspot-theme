...
(function () {
  function init() {
    ...
    var SMOKE_VEIL = COMMON +
      ...
      'vec3 tN=vec3(0.42,0.78,1.00);vec3 tD=vec3(0.12,0.61,1.00);' +
      'vec3 bN=vec3(0.44,0.55,1.00);vec3 bD=vec3(0.16,0.36,1.00);' +
      'vec3 kN=vec3(0.44,0.55,1.00);vec3 kD=vec3(0.16,0.36,1.00);' +
